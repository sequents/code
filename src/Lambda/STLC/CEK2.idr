...
step (R (Cl (Lam t)          e) (Fun (Cl t1 e1) s)) = Just $ L  t1                    e1 (Arg (Cl (Lam t) e) s)
step (R (Cl (Lam t)          e) (Arg (Cl t1 e1) s)) = Just $ L  t          (Cl t1 e1::e)                     s
...
private
test1 : runCEK TestTm1 = (11, R (Cl ResultTm []) Mt)
test1 = Refl

private
test2 : runCEK TestTm2 = (11, R (Cl ResultTm []) Mt)
test2 = Refl
