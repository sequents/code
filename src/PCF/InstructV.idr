...
step (Ev      ctr                      e (Fun (Cl (MkCtr k c (Grab::j)) e1) s)) = Just $ Ev (MkCtr k c j)                          (CE (Cl ctr e) e1)                 s
step (Ev      ctr                      e                     (Arg (Cl j e1) s)) = Just $ Ev            j                                          e1  (Fun (Cl ctr e) s)
...
step (Ev {g} (MkCtr _ _      (Nul::_)) _                                    s ) = Just $ Rw (MkCtr g A [Nul])                                                         s
